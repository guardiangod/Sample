...
(function(E, X) {
        ...
        for (var c = "{", d = !1, e, f, g, h, i, k = []; (c = a.indexOf(c)) !== -1; ) {
            ...
            if (d) {
                ...
                if (f.length)
                    ...
                    e !== null  && (e = B.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Qa(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{"
    ...
    function Fb() {
        ...
        kb = function(a, c, d, h, i, k) {
            var j;
            b ? (j = qa.UTC.apply(0, arguments),
            j += Ya(j)) : j = (new qa(a,c,p(d, 1),p(h, 0),p(i, 0),p(k, 0))).getTime();
            return j
        }
        ;
        tb = c + "Minutes";
    ...
    Wa = function(a, b, c) {
        ...
        for (h in b)
            ...
            g.toD = b.d,
            d = 0,
            f = 1) : a.attr ? d = a.attr(h) : (d = parseFloat(ja(a, h)) || 0,
            h !== "opacity" && (e = "px")),
            f || (f = b[h]),
    ...
    if (E.jQuery)
        E.jQuery.fn.highcharts = function() {
            ...
            if (this[0])
                return a[0] ? (new (B[xa(a[0]) ? a.shift() : "Chart"])(this[0],a[0],a[1]),
                this) : S[K(this[0], "data-highcharts-chart")]
        }
        ;
    ...
    O.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && n && !q(g.gradientUnits) && (h = g,
                ...
                for (r in j)
                    s.push(j[r]);
                s = s.join(",");
                i[s] ? n = i[s].attr("id") : (g.id = n = "highcharts-" + zb++,
        ...
        getBBox: function(a, b) {
            ...
            f = p(b, this.rotation);
            g = f * ga;
            e !== z && (r = ["", f || 0, i && i.fontSize, h.style.width].join(","),
            r = e === "" || Rb.test(e) ? "num:" + e.toString().length + r : e + r);
            r && !a && (c = m[r]);
            if (!c) {
                if (h.namespaceURI === Fa || d.forExport) {
                    try {
                        ...
                        ,
                        Ma && j.textShadow ? (k = j.textShadow,
                        j.textShadow = "") : l && l("none"),
        ...
        titleSetter: function(a) {
            ...
            b || (b = y.createElementNS(Fa, "title"),
    ...
    Ca.prototype = {
        ...
        buildText: function(a) {
            ...
            ; s--; )
                b.removeChild(g[s]);
            !f && !n && !r && e.indexOf(" ") === -1 ? b.appendChild(y.createTextNode(x(e))) : (h = /<.*style="([^"]+)".*>/,
            i = /<.*href="(http[^"]+)".*>/,
            R && R.appendChild(b),
            ...
            o(e, function(e, f) {
                ...
                o(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        K(s, "style", p));
                        i.test(e) && !d && (K(s, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                        L(s, {
                            cursor: "pointer"
                        }));
                        e = x(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            K(s, "dy", v(s)));
                            if (l) {
                                for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), R = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap", o, w, q, t = [], u = v(s), A = 1, z = a.rotation, B = e, D = B.length; (R || r) && (n.length || t.length); )
                                    a.rotation = 0,
                                    o = a.getBBox(!0),
                                    q = o.width,
                                    ...
                                    r && w ? (D /= 2,
                                    B === "" || !o && D < 0.5 ? n = [] : (o && (w = !0),
                                    B = e.substring(0, B.length + (o ? -1 : 1) * ua(D)),
                                    n = [B + (l > 3 ? "\u2026" : 
                                    "")],
                                    ...
                                    p && K(s, "style", p),
                                    b.appendChild(s)),
                                    q > l && (l = q)) : (s.removeChild(s.firstChild),
                                    t.unshift(n.pop())),
        ...
        fontMetrics: function(a, b) {
            ...
            !a && b && E.getComputedStyle && (b = b.element || b,
            a = (c = E.getComputedStyle(b, "")) && c.fontSize);
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            var k = this, j = k.g(i), l = k.text("", 0, 0, g).attr({
                zIndex: 1
            }), m, n, r = 0, s = 3, p = 0, v, x, w, t, ba = 0, gb = {}, B, y, Bb, F, E;
            Bb = function() {
                var a, b;
                a = l.element.style;
                ...
                if (y) {
                    if (!m)
                        ...
                        b = (h ? -B : 0) + ba,
                        j.box = 
                        m = d ? k.symbol(d, a, b, j.width, j.height, gb) : k.rect(a, b, j.width, j.height, 0, gb["stroke-width"]),
                    ...
                    if (c === "fill")
                        if (i === "gradient")
                            ...
                            var k = m.r, t = k * 2, u = k * 2, A = m.cx, B = m.cy, z = b.radialReference, y, k = function() {
                                z && (y = 
                                d.getBBox(),
                                A += (z[0] - y.x) / y.width - 0.5,
                                B += (z[1] - y.y) / y.height - 0.5,
                                t *= z[2] / y.width,
                                u *= z[2] / y.height);
    ...
    Va.prototype = {
        ...
        handleOverflow: function(a) {
            ...
            if (h)
                h < 0 && c - i * k < f ? m = A(c / U(h * ga) - f) : h > 0 && c + i * k > e && (m = A((d - c) / U(h * ga)));
            else if (d = c + (1 - i) * k,
            c - i * k < f ? j = a.x + j * (1 - i) - f : d > e && (j = e - a.x + j * i,
            l = -1),
            j = F(b.slotWidth, j),
        ...
        render: function(a, b, c) {
            ...
            if (i && !isNaN(A))
                ...
                q && a % q && (ba = !1),
                ba && !isNaN(u.y) ? (u.opacity = c,
                i[this.isNew ? "attr" : "animate"](u),
    ...
    B.PlotLineOrBand.prototype = {
        render: function() {
            ...
            else if (n && n.length && (a.svgElem = m = w.path(n).attr(x).add(),
            v))
            ...
            this.renderLabel(e, n, k, o)) : f && f.hide();
            return a
        },
    ...
    ka.prototype = {
        ...
        init: function(a, b) {
            ...
            sa(this, a.axes) === -1 && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this),
            ...
            o(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (d = c.xData,
                        d.length)
                            a.dataMin = F(p(a.dataMin, d[0]), Ra(d)),
        ...
        b, c, d, e, f) {
            ...
            f === "between" && (f = 0.5),
            a = h * (a - d) * k + i + h * j + (ma(f) ? k * f * g.pointRange : 0));
            return a
        },
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            ...
            var n = function(a, b, c) {
              ...
              , a = c = A(e + i);
            i = k = A(j - e - i);
            isNaN(e) ? m = !0 : this.horiz ? (i = h,
            k = j - this.bottom,
            a = c = n(a, g, g + this.width)) : (a = g,
            c = l - this.right,
            i = k = n(i, h, h + this.height));
        ...
        setAxisTranslation: function(a) {
            ...
            if (j || i || d)
                ...
                g = h.pointRangePadding) : (o(b.series, 
                function(a) {
        ...
        setTickInterval: function(a) {
            ...
            d.type !== 
            b.linkedParent.options.type && X(11, 1)) : (!r && q(n) && (b.dataMin >= n ? (s = n,
            k = 0) : b.dataMax <= n && (R = n,
            i = 0)),
            b.min = p(v, s, b.dataMin),
            b.max = p(x, R, b.dataMax));
            if (e)
                !a && F(b.min, p(b.dataMin, b.min)) <= 0 && X(10, 1),
                b.min = fa(Da(b.min), 15),
                b.max = fa(Da(b.max), 15);
            if (b.range && q(b.max))
                b.userMin = b.min = v = t(b.min, b.minFromRange()),
                b.userMax = x = b.max,
                b.range = null ;
            ...
            if (!j && b.tickInterval < a)
                b.tickInterval = a;
            if (!f && !e && !j)
                b.tickInterval = sb(b.tickInterval, null , rb(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), 
                !!this.tickAmount);
        ...
        setTickPositions: function() {
            ...
            a.units), this.min, this.max, a.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max),
            ...
            !j)) {
                ...
                for (n = c.length; !f && n--; )
                    ...
                    i = d[r].label)
                        ...
                        i.getBBox().height > this.len / c.length - (h.h - h.f) || d[r].labelLength > g)
                            i.specCss = {
        ...
        getOffset: function() {
            ...
            if (r && r.text && r.enabled !== !1) {
                if (!a.axisTitle)
                    a.axisTitle = c.text(r.text, 0, 0, r.useHTML).attr({
                        zIndex: 7,
        ...
        drawCrosshair: function(a, b) {
            ...
            if (!this.crosshair || (q(b) || !p(d.snap, !0)) === !1)
                this.hideCrosshair();
    ...
    ka.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (q(b)) {
            ...
            if (k >= G.second)
                i[Hb](k >= G.minute ? 0 : j * T(i.getSeconds() / j));
            if (k >= G.minute)
                i[Ib](k >= G.hour ? 0 : j * T(i[tb]() / j));
            if (k >= G.hour)
                i[Jb](k >= G.day ? 0 : j * T(i[ub]() / j));
            if (k >= G.day)
                i[wb](k >= G.month ? 
                1 : j * T(i[$a]() / j));
            k >= G.month && (i[xb](k >= G.year ? 0 : j * T(i[ab]() / j)),
            h = i[bb]());
            k >= G.year && (h -= h % j,
            i[yb](h));
            if (k === G.week)
    ...
    Pb.prototype = {
        ...
        getPosition: function(a, b, c) {
            ...
            , r = function() {
                l.apply(0, i) !== !1 ? m.apply(0, k) === !1 && !h && (n(!0),
                r()) : h ? f.x = f.y = 0 : (n(!0),
                r())
            }
            ;
        ...
        refresh: function(a, b) {
            ...
            k === !1 ? this.hide() : (this.isHidden && (Oa(d),
            d.attr("opacity", 
            1).show()),
            d.attr({
                text: k
    ...
    Xa.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (!e && !g)
                for (b = 0; b < c.length; b++)
                    if (c[b].directTouch || !c[b].options.stickyTracking)
                        c = [];
            ...
            o(j, function(a) {
                a && o(["dist", "distX"], function(b, c) {
                    typeof a[b] === "number" && a[b] < h[c] && (h[c] = a[b],
                    l[c] = a)
                })
            }));
            if (e)
            ...
            if (!this._onDocumentMouseMove)
                this._onDocumentMouseMove = function(a) {
                    if (S[ea])
                        S[ea].pointer.onDocumentMouseMove(a)
                }
                ,
        ...
        scaleGroups: function(a, b) {
            ...
            o(c.series, function(e) {
                d = a || e.getPlotBox();
                e.xAxis && 
                e.xAxis.zoomEnabled && (e.group.attr(d),
        ...
        drag: function(a) {
            ...
            if (!m || !m.touch)
                if (d < h ? d = h : d > h + k && (d = h + k),
                e < i ? e = i : e > i + j && (e = i + j),
                this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(r - e, 2)),
                this.hasDragged > 10) {
    ...
    u(B.Pointer.prototype, {
        ...
        touch: function(a, b) {
            ...
            c.isInsidePlot(a.chartX - c.plotLeft, 
            a.chartY - c.plotTop) && !c.openMenu ? (b && this.runPointActions(a),
    ...
    if (E.PointerEvent || E.MSPointerEvent) {
        var va = {}
          ...
          , Eb = function(a, b, c, d) {
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && S[ea])
                d(a),
                d = S[ea].pointer,
                d[b]({
                    type: c,
    ...
    ob.prototype = {
        ...
        renderTitle: function() {
            ...
            if (b.text) {
                if (!this.title)
                    this.title = this.chart.renderer.label(b.text, a - 3, a - 4, null , null , null , null , 
        ...
        renderItem: function(a) {
            ...
            e ? this.itemX += f : (this.itemY += r + g + n,
        ...
        getAllItems: function() {
            ...
            o(this.chart.series, function(b) {
                var c = b.options;
                if (p(c.showInLegend, !q(c.linkedTo) ? z : !1, !0))
        ...
        handleOverflow: function(a) {
            ...
            if (a > f) {
                ...
                if (!i)
                    i = b.clipRect = d.clipRect(0, r, 9999, 0),
    ...
    hb.prototype = {
        ...
        redraw: function(a) {
            ...
            o(c, function(a) {
                a.isDirty && 
                a.options.legendType === "point" && (a.updateTotals && a.updateTotals(),
                f = !0)
            });
        ...
        getChartSize: function() {
            ...
            if (!q(b))
                this.containerWidth = ja(c, "width");
            if (!q(a))
        ...
        setSize: function(a, b, c) {
            ...
            if (q(a))
                d.chartWidth = e = t(0, A(a)),
                d.hasUserSize = !!e;
            if (q(b))
                d.chartHeight = f = t(0, A(b));
            a = g.globalAnimation;
            (a ? Wa : L)(d.container, {
                width: e + "px",
                height: f + "px"
        ...
        drawChartBox: function() {
            ...
            if (j)
                f ? f.animate(x) : this.plotBackground = b.rect(r, p, o, v, 0).attr({
                    fill: j
                }).add().shadow(a.plotShadow);
            if (l)
                h ? h.animate(x) : this.plotBGImage = b.image(l, r, p, o, v).add();
            w ? w.animate({
                width: t.width,
                height: t.height
    ...
    Q.prototype = {
        ...
        generatePoints: function() {
            ...
            for (m = 0; m < g; m++)
                i = h + m,
                k ? l[m] = (new f).init(this, [d[m]].concat(ta(e[m]))) : (b[i] ? j = b[i] : a[i] !== z && (b[i] = j = (new f).init(this, 
                a[i], d[m])),
                l[m] = j),
                l[m].index = i;
            if (b && (g !== (c = b.length) || k))
        ...
        getExtremes: function(a) {
            ...
            for (l = 0; l < d; l++)
                ...
                k = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || 
                (c[l + 1] || k) >= g && (c[l - 1] || k) <= h,
                i && k)
                    if (i = j.length)
                        for (; i--; )
            ...
            if (l.enabled !== !1 || this._hasPointMarkers)
                ...
                b.length; f--; )
                    ...
                    a && e !== z && !isNaN(e) && g.y !== null )
                        ...
                        k = i.indexOf("url") === 0,
                        j)
                            j[o ? "show" : "hide"](!0).attr(a).animate(u({
                                x: d - h,
                                y: e - h
                            }, j.symbolName ? {
                                width: 2 * h,
                            ...
                            if (o && (h > 0 || k))
                                g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, r ? n : l).attr(a).add(t)
                        }
                    else if (j)
                        g.graphic = j.destroy()
        },
        ...
        getAttribs: function() {
            ...
            e.negativeColor = e.negativeColor || ia(e.negativeColor || h).brighten(e.brightness).get());
        ...
        destroy: function() {
            ...
            for (g in a)
                a[g] instanceof O && !a[g].survive && 
                (d = c && g === "group" ? "hide" : "destroy",
                a[g][d]());
            if (b.hoverSeries === a)
                b.hoverSeries = null ;
            oa(b.series, a);
        ...
        getGraphPath: function(a, b, c) {
            ...
            o(a, function(g, j) {
                ...
                g.plotY] : d.getPointSpline ? n = d.getPointSpline(a, g, j) : f ? (n = f === 1 ? ["L", n.plotX, m] : f === 2 ? ["L", (n.plotX + l) / 2, n.plotY, "L", (n.plotX + l) / 2, m] : ["L", l, n.plotY],
                n.push("L", l, m)) : n = ["L", l, m],
                h.push.apply(h, n),
                i = !1)
            });
    ...
    Q.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (x = 0; x < d; x++) {
                ...
                m[q] || (m[q] = {});
                if (!m[q][w])
                    n[q] && n[q][w] ? (m[q][w] = n[q][w],
                    m[q][w].total = null ) : m[q][w] = new Kb(l,l.options.stackLabels,s,w,h);
                q = m[q][w];
                if (u !== null )
                    q.points[v] = q.points[this.index] = [p(q.cum, g)],
                    q.touched = l.stacksTouched,
                    o.index > 0 && this.singleStacks === !1 && (q.points[v][0] = q.points[this.index + "," + w + ",0"][0]);
                e === "percent" ? (s = s ? i : k,
                j && m[s] && m[s][w] ? (s = m[s][w],
                q.total = s.total = t(s.total, q.total) + P(u) || 0) : q.total = fa(q.total + (P(u) || 0))) : q.total = fa(q.total + (u || 0));
                q.cum = p(q.cum, g) + (u || 0);
    ...
    wa = pa(Q, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            if (f && !f.isNull && c && !c.isNull) {
                ...
                k += j;
                h > a && h > e ? (h = t(a, e),
                k = 2 * e - h) : h < a && h < e && (h = F(a, e),
                k = 2 * e - h);
                k > c && k > e ? (k = t(c, e),
                h = 2 * e - k) : k < c && k < e && (k = F(c, e),
                h = 2 * e - k);
                b.rightContX = i;
                b.rightContY = k
            }
    ...
    wa = pa(Q, {
        ...
        drawPoints: function() {
            ...
            o(a.points, function(h) {
                ...
                if (i !== z && !isNaN(i) && h.y !== null )
                    ...
                    k ? (Oa(k),
                    k.attr(i).attr(g)[b.pointCount < e ? "animate" : "attr"](D(f))) : h.graphic = d[h.shapeType](f).attr(i).attr(g).add(h.group || a.group).shadow(c.shadow, null , c.stacking && !c.borderRadius);
                else if (k)
                    h.graphic = k.destroy()
            })
        },
        animate: function(a) {
            ...
            if (ca)
                a ? (e.scaleY = 0.001,
                a = F(b.pos + 
                b.len, t(b.pos, b.toPixels(c.threshold))),
    ...
    Q.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (n)
            ...
            h = (l + 720) % 360,
            h = h > 180 && h < 360,
            m === "left" ? g.y -= h ? k.height : 0 : m === "center" ? (g.x -= k.width / 2,
            g.y -= k.height / 2) : m === "right" && (g.x -= k.width,
            g.y -= h ? 0 : k.height)) : (b.align(c, null , d),
            g = b.alignAttr),
            o ? this.justifyDataLabel(b, c, g, k, d, e) : p(c.crop, !0) && (n = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, 
            g.y + k.height)),
            c.shape && !l && b.attr({
                anchorX: a.plotX,
                anchorY: a.plotY
    ...
    Q.prototype.justifyDataLabel = function(a, b, c, d, e, f) {
        ...
        k = c.x + l;
        if (k < 0)
            h === "right" ? b.align = "left" : b.x = -k,
            j = !0;
        k = c.x + d.width - l;
        if (k > g.plotWidth)
            h === "left" ? b.align = "right" : b.x = g.plotWidth - k,
            j = !0;
        k = c.y + l;
        if (k < 0)
            i === "bottom" ? b.verticalAlign = "top" : b.y = -k,
            j = !0;
        k = c.y + d.height - l;
        if (k > g.plotHeight)
            i === "top" ? b.verticalAlign = "bottom" : 
            b.y = g.plotHeight - k,
            j = !0;
        if (j)
            a.placed = !f,
    ...
    if (I.pie)
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (D = 2; D--; ) {
                    ...
                    if (K) {
                        ...
                        for (C = b = 0; !b && I[C]; )
                            b = I[C] && I[C].dataLabel && (I[C].dataLabel.getBBox().height || 21),
                            C++;
                        if (m > 0) {
                            x = F(q + r + m, d.plotHeight);
                            for (C = t(0, q - r - m); C <= x; C += b)
                                H.push(C);
                            x = H.length;
                            if (K > x) {
                                c = [].concat(I);
                            ...
                            for (C = 0; C < K; C++) {
                                ...
                                if (J < C && H[C] !== null )
                                    ...
                                    for (x < K - C + J && H[C] !== null  && (J = x - K + C); H[J] === null ; )
                                        J++;
                                M.push({
                                    i: J,
                                    y: H[J]
                ...
                if (Ea(G) === 0 || this.verifyDataLabelOverflow(G))
                    ...
                    u && g && o(this.points, function(b) {
                        ...
                        if ((v = b.dataLabel) && v._pos && b.visible)
                            ...
                            z = v.connX,
                            y = v.connY,
                            j = l ? ["M", z + (w[6] === "left" ? 5 : -5), y, "C", z, y, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", z + (w[6] === "left" ? 5 : -5), y, "L", 
                            w[2], w[3], "L", w[4], w[5]],
                            k ? (k.animate({
                                d: j
                            }),
        ...
        I.pie.prototype.verifyDataLabelOverflow = 
        function(a) {
    ...
    (function(a) {
        ...
        b.prototype.hideOverlappingLabels = function(a) {
            ...
            for (e = 0; e < b; e++) {
                ...
                for (d = e + 1; d < b; ++d)
                    if (j = a[d],
                    k && j && k.placed && j.placed && k.newOpacity !== 0 && j.newOpacity !== 0 && (l = k.alignAttr,
                    m = j.alignAttr,
                    n = k.parentGroup,
                    o = j.parentGroup,
                    p = 2 * (k.box ? 0 : k.padding),
                    l = !(m.x + o.translateX > l.x + n.translateX + (k.width - p) || m.x + o.translateX + (j.width - 
                    p) < l.x + n.translateX || m.y + o.translateY > l.y + n.translateY + (k.height - p) || m.y + o.translateY + (j.height - p) < l.y + n.translateY)))
    ...
    if (I.column)
        wa.prototype.drawTracker = da.drawTrackerPoint;
    if (I.pie)
        I.pie.prototype.drawTracker = da.drawTrackerPoint;
    if (I.scatter)
        la.prototype.drawTracker = da.drawTrackerPoint;
    u(ob.prototype, {
