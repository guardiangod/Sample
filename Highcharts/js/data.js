...
(function(g) {
    ...
    g.extend(p.prototype, {
        ...
        parseCSV: function() {
            ...
            i = a.itemDelimiter || (e.indexOf("\t") !== -1 ? "\t" : ","),
            j(g, function(a, e) {
                var g = b.trim(a)
                  , w = g.indexOf("#") === 0;
                e >= d && e <= c && !w && g !== "" && (g = a.split(i),
                j(g, function(b, a) {
                    a >= h && a <= q && (f[a - h] || (f[a - h] = []),
                    f[a - h][s] = b)
                }),
        ...
        parseTable: function() {
            ...
            a && (typeof a === "string" && (a = t.getElementById(a)),
            j(a.getElementsByTagName("tr"), function(b, a) {
            ...
            e && jQuery.ajax({
                ...
                success: function(a) {
                    ...
                    for (l = 0; l < n; l++)
                        ...
                        k = Math.max(k, e.gs$cell.row);
                    for (l = 0; l < m; l++)
                        if (l >= 
                        h && l <= g)
                            f[l - h] = [],
                            f[l - h].length = Math.min(k, c - d);
                    for (l = 0; l < n; l++)
                        if (e = a[l],
                        i = e.gs$cell.row - 1,
                        j = e.gs$cell.col - 1,
                        j >= h && j <= g && i >= d && i <= c)
                            f[j - h][i - d] = e.content.$t;
                    b.dataFound()
                }
            })
        },
        trim: function(b, a) {
            typeof b === "string" && (b = b.replace(/^\s+|\s+$/g, ""),
            ...
            for (e[a] || (e[a] = []); d--; )
                ...
                "number" && !isNaN(h) && p !== "float") {
                    ...
                    b[d + 1] !== void 0) {
                        c = h > b[d + 1];
                        if (c !== m && m !== void 0)
                            this.alternativeFormat ? (this.dateFormat = this.alternativeFormat,
                            d = b.length,
                            this.alternativeFormat = this.dateFormats[this.dateFormat].alternative) : b.unsorted = !0;
                        m = c
                    }
                } else if (b[d] = g === "" ? null  : g,
                d !== 0 && (b.isDatetime || b.isNumeric))
                    b.mixed = !0;
            k && b.mixed && (f[a] = e[a]);
            if (k && m && this.options.sort)
                for (a = 0; a < f.length; a++)
                    f[a].reverse(),
                    j && f[a].unshift(f[a].pop())
        },
        dateFormats: {
            "YYYY-mm-dd": {
        ...
        complete: function() {
            ...
            if (e.complete || e.afterComplete) {
                ...
                for (c = 0; c < this.valueCount.seriesBuilders.length; c++)
                    i = this.valueCount.seriesBuilders[c],
                ...
                g.length > 0 && g[0].readers.length > 0 && (i = b[g[0].readers[0].columnIndex],
                i !== void 0 && (i.isDatetime ? a = "datetime" : i.isNumeric || (a = "category")));
                if (a === "category")
    ...
    k.prototype.read = function(b, a) {
        ...
        if (this.name === void 0 && this.readers.length >= 2 && (d = this.getReferencedColumnIndexes(),
        d.length >= 2))
            d.shift(),
            d.sort(),
