(function(d) {
    ...
    function A(a, b, c) {
        var e;
        !b.rgba.length || !a.rgba.length ? a = b.input || "none" : (a = a.rgba,
        b = b.rgba,
        e = b[3] !== 1 || a[3] !== 1,
        a = (e ? "rgba(" : "rgb(") + Math.round(b[0] + (a[0] - b[0]) * (1 - c)) + "," + Math.round(b[1] + (a[1] - b[1]) * (1 - c)) + "," + Math.round(b[2] + (a[2] - b[2]) * (1 - c)) + (e ? "," + (b[3] + (a[3] - b[3]) * (1 - c)) : "") + ")");
        return a
    }
    var t = function() {}
      , q = d.getOptions()
    ...
    m.prototype.addSingleSeriesAsDrilldown = function(a, b) {
        ...
        h(c.chart.series, function(a) {
            if (a.xAxis === e && !a.isDrilling)
                a.options._ddSeriesId = a.options._ddSeriesId || z++,
                a.options._colorIndex = a.userOptions._colorIndex,
                a.options._levelNumber = a.options._levelNumber || k,
                o ? (d = o.levelSeries,
                j = o.levelSeriesOptions) : (d.push(a),
                j.push(a.options))
        });
        f = {
            levelNumber: k,
        ...
        if (c.type === f.type)
            f.animate = f.animateDrilldown || t,
            f.options.animation = !0
    }
    ;
    ...
    m.prototype.getDrilldownBackText = function() {
        ...
        if (a && a.length > 0)
            ...
            B(this.options.lang.drillUpText, a)
    }
    ;
    ...
    m.prototype.drillUp = function() {
        for (var a = this, b = a.drilldownLevels, c = b[b.length - 1].levelNumber, e = b.length, g = a.series, f, i, d, j, k = function(b) {
            ...
            c = c || a.addSeries(b, !1);
            if (c.type === d.type && c.animateDrillupTo)
        ...
        ; e--; )
            ...
            i.levelNumber === c) {
                ...
                if (!d.chart)
                    for (f = g.length; f--; )
                        if (g[f].options.id === i.lowerSeriesOptions.id && g[f].options._levelNumber === c + 1) {
                            d = g[f];
                            break
                        }
                d.xData = [];
                ...
                if (j.type === d.type)
                    ...
                    d.animateDrillupFrom && d.chart && d.animateDrillupFrom(i);
                j.options._levelNumber = c;
                d.remove(!1);
                if (j.xAxis)
                    f = i.oldExtremes,
                    j.xAxis.setExtremes(f.xMin, f.xMax, !1),
                    j.yAxis.setExtremes(f.yMin, f.yMax, !1)
            }
        this.redraw();
        ...
        if (!a) {
            ...
            setTimeout(function() {
                ...
                h(b.points, function(a, b) {
                    var f = b === (c && c.pointIndex) ? "show" : "fadeIn"
                      , d = f === "show" ? !0 : void 0;
                    if (a.graphic)
                        a.graphic[f](d);
                    if (a.dataLabel)
    ...
    n.prototype.animateDrilldown = function(a) {
        ...
        if (!a)
            ...
            e.x += u(f.oldPos, f.pos) - f.pos,
            h(this.points, function(a) {
                a.graphic && a.graphic.attr(e).animate(l(a.shapeArgs, {
                    fill: a.color
                }), d);
    ...
    d.Point.prototype.doDrilldown = function(a, b) {
        ...
        if (!c.ddDupes)
            c.ddDupes = [];
        for (; d-- && !f; )
            e.series[d].id === this.drilldown && y(this.drilldown, c.ddDupes) === -1 && (f = e.series[d],
    ...
    r(d.Point.prototype, "init", function(a, b, c, e) {
        ...
        c))
            c.push(g),
            c.levelNumber = b.options._levelNumber;
        a && a.drillable();
        return g
    });
    ...
    ;
    for (s in p)
        p[s].prototype.supportsDrilldown && r(p[s].prototype, "drawTracker", q)
});